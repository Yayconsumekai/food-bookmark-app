<template>
  <div class="search-page">
    ...
    <div class="search-layout">
      ...
      <FacetSidebar
        v-if="search.results.length || hasActiveFilters"
...
.empty-state {
  text-align: center; color: #888; padding: 4rem 0;
}
.empty-state button {
  margin-top: 1rem; background: #f6c90e;
