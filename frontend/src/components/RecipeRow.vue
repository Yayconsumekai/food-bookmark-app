<template>
        ...
        >
          <div class="card-img">
            <img
              ...
              loading="lazy"
            />
            <div v-else class="card-no-img">🍽️</div>
  
            <!-- Similarity badge for ML suggestions -->
  ...
  <style scoped>
  .recipe-row      { margin-bottom: 2.5rem; }
  ...
  .row-title       { font-size: 1.25rem; font-weight: 700; margin: 0; }
  .row-subtitle    { font-size: 0.85rem; color: #888; margin: 0.2rem 0 0; }
  ...
  .row-scroll::-webkit-scrollbar-thumb { background: #e0e0e0; border-radius: 4px; }
  ...
  .card-img      { height: 130px; overflow: hidden; background: #f5f5f5; position: relative; }
  ...
  .card-name     { font-size: 0.85rem; font-weight: 600; margin: 0 0 0.3rem; line-height: 1.3;
                   display: -webkit-box; -webkit-line-clamp: 2;
                   -webkit-box-orient: vertical; overflow: hidden; }
  .card-meta     { display: flex; gap: 0.5rem; font-size: 0.75rem; color: #888; flex-wrap: wrap; }
  ...
  .row-empty { color: #aaa; font-size: 0.9rem; padding: 1rem 0; }
  </style>