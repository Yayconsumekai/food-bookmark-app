<template>
  ...
  .suggest-title   { font-size: 1rem; font-weight: 700; margin: 0; }
  .suggest-subtitle {
  ...
  .card-img      { height: 120px; overflow: hidden; background: #f5f5f5; position: relative; }
  ...
  .card-info     { padding: 0.55rem; }
  .card-name     {
    font-size: 0.82rem; font-weight: 600; margin: 0 0 0.25rem;
    display: -webkit-box; -webkit-line-clamp: 2;
    -webkit-box-orient: vertical; overflow: hidden;
  }
  .card-meta     { display: flex; gap: 0.4rem; font-size: 0.72rem; color: #888; flex-wrap: wrap; }
  .cat-tag       {
    background: #f0f0f0; border-radius: 4px;
    padding: 0.1rem 0.35rem;
  }
  .suggest-empty { color: #aaa; font-size: 0.85rem; padding: 1rem 0; text-align: center; }
  
  .skeleton-card {
    width: 180px; height: 190px; flex-shrink: 0;
    border-radius: 10px;
